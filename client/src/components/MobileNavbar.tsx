    ...
    <nav className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-6">
          <Link href="/">
            <div
              className={`flex items-center gap-1 font-medium cursor-pointer ${currentPage === "route" ? "text-blue-600" : "text-gray-700 hover:text-gray-900"}`}
            >
              <Map size={18} />
          ...
          <Link href="/upload">
            <div
              className={`flex items-center gap-1 font-medium cursor-pointer ${currentPage === "upload" ? "text-blue-600" : "text-gray-700 hover:text-gray-900"}`}
            >
              <Upload size={18} />
              <span>Upload Infomation</span>
            </div>
          </Link>
          <button
